    ...
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 bg-white">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-gray-800 mb-2">Rice Terraces, Tegallalang</h2>
            <p className="text-gray-600 leading-[1.625]">
          ...
          <div className="max-w-2xl mx-auto p-6">
            ...
            <div>
              ...
              <p className="text-sm mb-6">Your email address will not be published. Required fields are marked *</p>
              <form>
                {/* Comment Field */}
                <div className="mb-4">
                  <label htmlFor="comment" className="block text-sm font-medium mb-2">Comment</label>
                  <textarea id="comment" className="w-full p-2 border border-gray-300 rounded" rows={4}></textarea>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <input type="url" id="website" className="w-full p-2 border border-gray-300 rounded" />
                </div>
                ...
                <div className="mb-4">
                  <label className="inline-flex items-center">
                    ...
                    <span className="ml-2 text-sm">Save my name, email, and website for the next time I comment.</span>
                  </label>
                </div>
